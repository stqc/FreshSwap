...
import discord from "./dc.png";
import tele from "./tg.png";
                            ...
                            {/* <div className="app-btn" style={{marginBottom:"5%"}}>
                             ...
                             <div style={{ height:"match-parent", padding:"2%"}}>
                                    <img src={twitter}onClick={()=>{
                                        window.open("https://twitter.com/freshswap_")
                                    }}/>
                                </div>
                                <div style={{ height:"match-parent", padding:"2%"}}>
                                    <img src={discord} onClick={()=>{
                                        window.open("https://discord.gg/Nm99mrsjHA")
                                    }}/>
                                </div>
                                <div style={{ height:"match-parent", padding:"2%"}}>
                                    <img src={tele} onClick={()=>{
                                        window.open("https://t.me/freshswap")
                                    }}/>
                                </div>
                             </div>
                        </div>
